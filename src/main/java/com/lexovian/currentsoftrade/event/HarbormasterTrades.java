 ...
 * Primary focus: Harbormaster buys commodities, catches and ocean goods from the player,
 * paying in Doubloons and Emeralds. Also sells essential harbor equipment, charts and vessels.
 */
...
public class HarbormasterTrades {
    ...
    public static void onVillagerTrades(VillagerTradesEvent event) {
        if (event.getType() == CurrentsofTrade.HARBORMASTER.get()) {
            Int2ObjectMap<List<VillagerTrades.ItemListing>> trades = event.getTrades();

            // Level 1: Novice - Harbor Intake & Provisions
            ...
            trades.get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 2), new ItemStack(CurrentsofTrade.DOUBLOON.get(), 1), 16, 1, 0.05F));
            trades.get(1).add(new BasicItemListing(new ItemStack(CurrentsofTrade.DOUBLOON.get(), 1), new ItemStack(Items.EMERALD, 2), 16, 1, 0.05F));
            ...
            // Level 3: Journeyman - Trade Commodities & Harbor Ledger
